...
public class Record {
    ...
    public String toString() {
        return new ToStringBuilder(this, STYLE).append("metadata", metadata).append("graphs", graphs).append("libraries", libraries).append("vulnerabilities", vulnerabilities).append("unmatchedLibraries", unmatchedLibraries).append("vulnMethods", vulnMethods).toString();
    }
